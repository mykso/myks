...
replace carvel.dev/ytt => github.com/mykso/ytt v0.47.2-0.20260114220430-7a160a700b3a

replace go.starlark.net => github.com/mykso/starlark-go v0.0.0-20201103203137-b73039650923
